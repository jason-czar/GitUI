...
export function ResponsiveMockupSection() {
    return (
        <>
            ...
            <div
                className="hidden md:block w-screen h-[44rem] flex items-center justify-center"
                id="features"
            >
            ...
            <div className="md:hidden">
                ...
                <div
                    className="w-screen relative overflow-hidden flex flex-col items-center justify-center py-14"
