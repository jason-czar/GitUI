    ...
    return (
        <div className="bg-black/80 backdrop-blur-sm border border-foreground-secondary/20 rounded-lg p-3 w-96 min-w-64 h-fit mt-10">
            <div className="flex items-center gap-2 mb-1">
                <h3 className="text-foreground-secondary text-xs font-mono">
            ...
            <div className="space-y-2">
                {notes.map((note, index) => (
                    <div key={index} className="flex items-start gap-2 text-[10px]">
                        ...
                        <span
                            className={`leading-relaxed font-mono ${index < 3 ? 'text-gray-500 line-through' : 'text-gray-300'}`}
                        >
                            {note}
                        </span>
                    </div>
        ...
        >
            ...
            >
                ...
                <div className="relative flex flex-col items-center border-1 border-teal-300 rounded-sm shadow-xl shadow-black/50">
                    <div className="absolute left-1/2 -translate-x-1/2 -top-7 z-50 w-full flex flex-row items-center rounded-lg h-6 text-xs px-1 gap-2.5 backdrop-blur-lg">
            ...
            <div className="grid grid-cols-3 items-center h-10 px-2.5 relative z-10">
                ...
                <div className="flex items-center gap-1 min-w-0">
                    ...
                    <span className="text-xs text-foreground-secondary ml-1 truncate max-w-[100px]">
                        Villainterest
                    </span>
                ...
                <div className="flex justify-center">
                    <div className="relative">
                        <div className="flex items-center gap-0 font-normal h-6 mt-1">
                            <button className="text-[12px] text-foreground-primary px-4 py-1 whitespace-nowrap bg-transparent cursor-pointer transition-all duration-150 ease-in-out">
                                Design
                            </button>
                            <button className="text-[12px] text-foreground-secondary px-4 py-1 whitespace-nowrap bg-transparent cursor-pointer transition-all duration-150 ease-in-out hover:text-neutral-300">
                                Preview
                            </button>
                        </div>
                                            ...
                                            <div
                                                ...
                                                className={cn(
                                                    ...
                                                    isComponent &&
                                                        !layer.isInstance &&
                                                        isHovered &&
                                                        'text-purple-500 bg-purple-800/50 dark:text-purple-200',
                                                    isComponent &&
                                                        !layer.isInstance &&
                                                        isSelected &&
                                                        'bg-purple-500 dark:bg-purple-500/90 text-white dark:text-primary',
                                                    // Instance styling
                                                    layer.isInstance &&
                                                        isSelected &&
                                                        'text-purple-100 dark:text-purple-100 bg-purple-700/70 dark:bg-purple-500/50',
                                                    layer.isInstance &&
                                                        !isSelected &&
                                                    ...
                                                    layer.isInstance &&
                                                        !isSelected &&
                                                        isHovered &&
                                                        'text-purple-800 dark:text-purple-200 bg-purple-400/30 dark:bg-purple-900/60',
                                                    // Regular selection styling
                                                    !isComponent &&
                                                        !layer.isInstance &&
                                                        isSelected &&
                                                        'bg-[#FA003C] dark:bg-[#FA003C]/90 text-white dark:text-primary',
                                                    !isComponent &&
                                                        !layer.isInstance &&
                                                        isHovered &&
                                                        !isSelected &&
                        ...
                        <div className="flex-1 flex flex-col justify-end">
                            ...
                            <div className="border-t border-foreground-primary/10 px-2.5 py-2 flex flex-col items-start gap-1">
                                ...
                                <div className="flex flex-row items-center justify-between w-full gap-2">
                                    <button
                                        className="px-1 py-2 rounded-lg flex flex-row items-center gap-2"
                                        disabled
                                    >
                                    ...
                                    <div className="flex flex-row gap-1">
                                        <button
                                            className="px-2 py-2 rounded-lg bg-background-secondary/0 hover:bg-background-secondary group cursor-copy"
                                            disabled
                                        >
                                            <Icons.Image className="h-4 w-4 text-foreground-tertiary/50 group-hover:text-foreground-primary" />
                                        </button>
                                        <button
                                            className={`px-2 py-2 rounded-full cursor-pointer ${currentIndex === PRESET_SENTENCE.length ? 'bg-foreground-primary' : 'bg-foreground-onlook'}`}
                                            disabled
                                        >
