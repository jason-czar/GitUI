...
function TestimonialCard({
    ...
    const cardContent = (
        <div
            className={`bg-background-onlook border border-foreground-secondary/10 rounded-xl p-6 flex flex-col justify-between min-h-[160px] duration-200 select-none ${href ? 'cursor-pointer hover:bg-background-onlook hover:border-foreground-secondary/20 transition-colors duration-50' : ''}`}
        >
