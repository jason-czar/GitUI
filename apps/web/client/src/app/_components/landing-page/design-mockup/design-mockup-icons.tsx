    ...
    Explore: ({ className, ...props }: IconProps) => (
        ...
        >
            <g clipPath="url(#clip0_9157_282181)">
                ...
                <path
                    d="M14.8287 9.17188L10.0003 10.0003L9.17188 14.8287L14.0003 14.0003L14.8287 9.17188Z"
                    stroke="currentColor"
                    strokeWidth="2"
                />
            </g>
    ...
    Messages: ({ className, ...props }: IconProps) => (
        ...
        >
            <g clipPath="url(#clip0_9157_282235)">
                <path
                    d="M20.0001 4H4V21.5L8 19H20.0001V4Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="square"
                />
    ...
    Notifications: ({ className, ...props }: IconProps) => (
        ...
        >
            <g clipPath="url(#clip0_9157_282249)">
                <path
                    d="M20 17H4V16L5.5 13L5.70037 8.99251C5.86822 5.63561 8.6389 3 12 3C15.3611 3 18.1318 5.63561 18.2996 8.99251L18.5 13L20 16V17Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="square"
                />
                ...
                <path
                    d="M8.03125 17.5C8.2773 19.4732 9.9605 21 12.0003 21C14.0401 21 15.7233 19.4732 15.9694 17.5"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="square"
                />
