        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-row gap-8 relative min-h-[400px] overflow-hidden bg-background-onlook/80 rounded-lg">
                ...
                <div className="w-56 h-100 rounded-xl overflow-hidden absolute lg:left-1/20 md:left-1/30 left-1/8 top-12 flex flex-col items-center justify-start bg-black border-[0.5px] border-foreground-primary/20">
                    <p className="text-foreground-primary text-regular font-light w-full text-left px-3 py-2 border-b-[0.5px] border-foreground-primary/20">
                        Components
                    </p>
                        ...
                        {[
                            ...
                            <div key={item.label} className="flex flex-col items-center w-full">
                                ...
                                >
                                    ...
                                    {item.label === 'Calendar' && (
                                        <div
                                            className="w-16 h-fit bg-black rounded-[4px] p-1.5 select-none"
                                            style={{ fontSize: '3px' }}
                                        >
                                    ...
                                    {item.label === 'Card' && (
                                        <div
                                            className="w-18 h-18 bg-black rounded-[4px] p-1.5 flex flex-col gap-[1.5px] select-none"
                                        ...
                                        >
                                            ...
                                            <span className="text-zinc-400 mb-0.5">
                                                Enter your email below
                                            </span>
                                            {/* Email field */}
                                            <div className="text-zinc-400 mb-0.5">Email</div>
                                            <div className="w-full h-2 bg-zinc-800 rounded-[1px] flex items-center px-0.5 text-zinc-500">
                                                m@example.com
                                            </div>
                                            {/* Password field */}
                                            ...
                                            {/* Login button */}
                                            <div className="w-full h-2 bg-white rounded-[1px] text-black flex items-center justify-center font-semibold mb-0.5">
                                                Login
                                            </div>
                                            {/* Google button */}
                                            <div className="w-full h-2 bg-zinc-900 rounded-[1px] text-white flex items-center justify-center">
                                                Login with Google
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {item.label === 'Chart' && (
                                        <div className="w-18 h-16 bg-black rounded-[4px] p-0.5 flex flex-col select-none overflow-hidden relative">
                                            ...
                                            <div className="px-1 pt-1 pb-0.5">
                                                <div className="text-white text-[4.5px] font-semibold leading-none mb-1">
                                                    Bar Chart
                                                </div>
                                                <div className="text-zinc-400 text-[3.2px] leading-none">
                                            ...
                                            <div className="flex-1 flex flex-col justify-end relative">
                                                {/* Grid lines */}
                                                <div
                                                    className="absolute left-0 right-0 top-[30%] h-[1px] bg-zinc-700/40"
                                                    style={{ zIndex: 1 }}
                                                ></div>
                                                <div
                                                    className="absolute left-0 right-0 top-[60%] h-[1px] bg-zinc-700/40"
                                                    style={{ zIndex: 1 }}
                                                ></div>
                                                {/* Bars */}
                                                <div
                                                    className="absolute left-0 right-0 bottom-0 flex items-end w-full gap-[0.5px] px-1 py-1 z-10"
                                    ...
                                    {item.label === 'Table' && (
                                        <div className="w-16 h-16 bg-black rounded-[4px] p-0.5 select-none">
                                            <div className="grid grid-cols-3 gap-[1px] text-[3px] text-zinc-300">
                                                <div className="bg-background-onlook p-1 rounded-[1px]">
                                                    Name
                                                </div>
                                                <div className="bg-background-onlook p-1 rounded-[1px]">
                                                    Age
                                    ...
                                    {item.label === 'Weather' && (
                                        <div className="w-16 h-16 bg-black rounded-[4px] p-1 flex flex-col items-center select-none relative overflow-hidden">
                                            ...
                                            <div className="flex items-center justify-center w-full mt-2">
                                                ...
                                                <div className="text-white text-[15px] font-light ml-1">
                                                    72°
                                                </div>
                                            </div>
                                            {/* Forecast bar */}
                                ...
                                <span className="text-foreground-secondary text-mini text-left w-full ml-[-12px]">
                                    {item.label}
                                </span>
                            </div>
                        ))}
                ...
                <div className="absolute md:right-1/30 right-1/10 top-30 z-10">
                    <div
                        className="rounded-xl border-1 border-purple-400 bg-black p-4 min-w-[240px]"
            ...
            <div className="flex flex-row items-start gap-8 w-full">
                ...
                <div className="flex flex-col items-start w-1/2">
                    <div className="mb-2">
                        <Icons.Component className="w-6 h-6 text-foreground-primary" />
                    </div>
