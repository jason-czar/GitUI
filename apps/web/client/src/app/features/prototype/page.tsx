            ...
            <div className="space-y-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex flex-col order-2 lg:order-1">
                        <h2 className="text-foreground-secondary text-sm font-medium uppercase tracking-wider mb-4">
                            AI-Powered Rapid Prototyping Tool
                        </h2>
                        <p className="text-foreground-primary text-2xl md:text-4xl font-light mb-6">
    ...
    return (
        <div className="w-full max-w-6xl mx-auto py-32 px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-20">
                <div>
                    <h2 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">
