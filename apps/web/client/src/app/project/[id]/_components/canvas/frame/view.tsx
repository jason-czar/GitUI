...
export const FrameComponent = observer(
    forwardRef<IFrameView, FrameViewProps>(
        ({ frame, reloadIframe, isInDragSelection = false, ...props }, ref) => {
                        ...
                        .then((child) => {
                            ...
                            if (!child) {
                                const error = new Error(
                                    'Failed to setup penpal connection: child is null',
                                );
                                console.error(
            ...
            return (
                <iframe
                    ...
                    src={frame.url}
                    sandbox="allow-modals allow-forms allow-same-origin allow-scripts allow-popups allow-downloads allow-popups-to-escape-sandbox allow-top-navigation"
                    ...
                    onLoad={() => {
                        ...
                        if (iframe?.contentWindow) {
                            try {
                                // Listen for dialog events and auto-accept
                                ...
                                console.debug('Cross-origin iframe access blocked (expected)');
                            }
                        }
                    }}
                    {...props}
