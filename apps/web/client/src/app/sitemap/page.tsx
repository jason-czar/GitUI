                ...
                <div className="max-w-4xl mx-auto px-8 py-16">
                    ...
                    <div className="prose prose-invert max-w-none">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                            {/* Company Section */}
                            <div>
                                <h2 className="text-2xl font-light text-foreground-primary mb-6">
                                    Company
                                </h2>
                                <ul className="space-y-4 text-foreground-secondary">
                                    <li>
                                        <a
                                            href={Routes.ABOUT}
                                            className="text-foreground-secondary text-regular hover:underline hover:text-foreground-primary"
                                        >
                                            About
                                        </a>
                                    </li>
